...
setuptools.setup(
    name="synchrony", # name of my package
    version="0.0.1",
    ...
    python_requires='>=3.6',
    entry_points= {'console_scripts': ['synchrony_run=synchrony.mainClass:run', 'synchrony_run_cluster=synchrony.mainClass:run_cluster']}
)
